...
*/
mail('administrador@quebuenaestoy.com', 'IPN', 'Ejecutado');
...
if ($verified) {
    ...
    */
    mail('administrador@quebuenaestoy.com', 'Verified IPN', $listener->getTextReport());
    ...
    if ($creditos > 0)
    {    
	$c = 'INSERT INTO credito (creditos, ID_cuenta) VALUES ('.$creditos.',(SELECT ID_cuenta FROM cuentas WHERE correo="'.$_POST['payer_email'].'"))';
	$r = db::consultar($c);
    }
    ...
    invalid IPN.
    */
    mail('administrador@quebuenaestoy.com', 'Invalid IPN', $listener->getTextReport());
}
