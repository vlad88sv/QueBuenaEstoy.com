...
if (!sesion::iniciado())
    error_log('Intento de usar carga.php sin iniciar sesión');
...
class qqFileUploader {
    ...
    function handleUpload($uploadDirectory, $replaceOldFile = FALSE){
        ...
        if ($this->file->save($uploadDirectory . $filename . '.' . $ext)){
            ...
            elseif (sesion::info('tipo') == 'perro')
            {
                db::consultar('UPDATE cuentas SET foto="'.$hash.'" WHERE ID_cuenta="'.sesion::info('ID_cuenta').'"');
                $_SESSION['info']['foto'] = $hash;
            }   
...
$result = $uploader->handleUpload('pool/xhr/');
